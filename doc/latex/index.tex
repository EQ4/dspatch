...
protected:
       ...
       successful )
                if( inputs.GetValue( 0, bool1 ) && //OR inputs.GetValue(
       "input1", bool1 );
                    inputs.GetValue( 1, bool2 ) )  //OR inputs.GetValue(
       "input2", bool2 );
                {
                        // set output as the result of bool1 AND bool2
                        outputs.SetValue( 0, bool1 && bool2 ); //OR
       outputs.SetValue( "output", bool1 && bool2 );
                }
        }
};
\end{DoxyCode}
...
\subsection{v.\-2.\-3 (15 December 2012)}\label{index_v23}

\begin{DoxyItemize}
\item Circuit interface simplified.
